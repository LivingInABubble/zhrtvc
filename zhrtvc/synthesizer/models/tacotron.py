...
from synthesizer.models.modules import EncoderConvolutions, EncoderRNN, Prenet, DecoderRNN, FrameProjection, \
    StopProjection, Postnet, CBHG, MaskedMSE, MaskedSigmoidCrossEntropy
...
class Tacotron:
    ...
    def initialize(self, inputs, input_lengths, embed_targets, mel_targets=None,
        ...
        if not gta and self._hparams.predict_linear is True and linear_targets is None and is_training:
            raise ValueError("Model is set to use post processing to predict linear spectrograms in training "
        ...
        with tf.device(split_device):
            ...
            tower_inputs, tower_mel_targets, tower_stop_token_targets = [], [], []
        ...
        tower_residual, tower_projected_residual = [], []
